...
export const metadata: Metadata = {
    ...
    description: 'ความประทับใจและรอยยิ้มจากลูกค้า Han Flower ทั่วไทย มั่นใจในคุณภาพช่อดอกไม้และของขวัญที่สร้างความสุขให้ทั้งผู้ให้และผู้รับ พร้อมบริการรวดเร็วและดูแลเอาใจใส่ทุกคำสั่งซื้อ',
