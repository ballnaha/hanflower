...
export const metadata = {
  ...
  keywords: ['ร้านดอกไม้ใกล้ฉัน', 'ส่งดอกไม้ด่วน', 'ร้านดอกไม้ออนไลน์', 'รับจัดดอกไม้งานแต่ง', 'ดอกไม้งานอีเว้นท์', 'ช่อดอกไม้พรีเมียม', 'Han Flower', 'Backdrop ดอกไม้', 'ซุ้มถ่ายรูปงานแต่ง'],
  openGraph: {
